...
#include "TimeLine.h"
#include "RunebergVR_Teleporter0.h"
#include "Kismet/KismetMathLibrary.h"
#include "IHeadMountedDisplay.h"


// Sets default values for this component's properties
URunebergVR_Teleporter0::URunebergVR_Teleporter0()
{
...
void URunebergVR_Teleporter0::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void URunebergVR_Teleporter0::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
// Draw Teleport Arc
void URunebergVR_Teleporter0::DrawTeleportArc()
{
...
// Clear Teleport arc
void URunebergVR_Teleporter0::ClearTeleportArc()
{
	// Clear Arc
	ArcPoints.Empty();
...
bool URunebergVR_Teleporter0::ShowTeleportArc()
{
	if (!IsTeleporting)
	{
		TeleportMode = 0;
...
bool URunebergVR_Teleporter0::HideTeleportArc()
{
	if (IsTeleporting)
	{
		TeleportMode = -1;
...
bool URunebergVR_Teleporter0::HideTeleportRay()
{
	if (IsTeleporting)
	{
		TeleportMode = -1;
...
// Clear Teleport ray
void URunebergVR_Teleporter0::ClearTeleportRay()
{
	if (RayMesh)
	{
...
// Draw Teleport Ray
void URunebergVR_Teleporter0::DrawTeleportRay()
{
...
bool URunebergVR_Teleporter0::ShowTeleportRay()
{
	if (!IsTeleporting)
	{
		TeleportMode = 1;
...
// Teleport object
bool URunebergVR_Teleporter0::TeleportNow()
{
...
bool URunebergVR_Teleporter0::ShowMarker()
{
	if (!IsTeleporting)
	{
...
// Remove Marker
bool URunebergVR_Teleporter0::HideMarker()
{
	if (IsTeleporting)
	{
		TeleportMode = -1;
...
// Move marker
bool URunebergVR_Teleporter0::MoveMarker(EMoveDirectionEnum MarkerDirection, int Rate, FRotator CustomDirection)
{
...
void URunebergVR_Teleporter0::SpawnTargetMarker(FVector MarkerLocation, FRotator MarkerRotation)
{
...
void URunebergVR_Teleporter0::RemoveTargetMarker()
{
...
// Show target location marker
void  URunebergVR_Teleporter0::SetTargetMarkerVisibility(bool MakeVisible)
{
	// Activate Particle System if available
	if (TargetParticleSystemComponent) {
...
void  URunebergVR_Teleporter0::SetTargetMarkerLocationAndRotation(FVector MarkerLocation, FRotator MarkerRotation)
{
	// Activate Particle System if available
	if (TargetParticleSystemComponent) {
